...
abstract class VacationAbstract implements VacationInterface {
    String place;
    String date;
...
class SummerVacation_Interface_17BCI0113 extends VacationAbstract {
    String courseTitle;
    String onlinePlatform;
    int duration;

    SummerVacation_Interface_17BCI0113(String place, String date, int cost, String title, String platform, int duration) {
        this.place = place;
        this.date = date;
    ...
    public static void main(String args[]) {
        ...
        SummerVacation_Interface_17BCI0113 objs[] = new SummerVacation_Interface_17BCI0113[count];
        ...
        for (int i = 0; i < count; i++) {
            ...
            objs[i] = new SummerVacation_Interface_17BCI0113(place, date, cost, title, platform, duration);
            System.out.println();
        }
        System.out.println("\nTotal Cost: " + SummerVacation_Interface_17BCI0113.getTotalCost());
    }
