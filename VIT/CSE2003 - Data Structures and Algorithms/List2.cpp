...
int main()
{
    ...
    do
    {
        ...
        switch(choice)
        {
            ...
            case 4: insertAtStart(List);
            		break;

            case 5: insertAtN(List); break;

            case 6: deleteFromEnd(List);
            break;

            case 7: deleteFromStart(List); break;

            case 8: deleteFromN(List); break;

            case 9: searchList(List);
            break;

            case 10: printList(List);
            break;
